...
from sqlalchemy import Column, Integer, String, Date, TEXT, Float, CHAR, BIGINT, ForeignKey, Table
...
class Product(Base):
    ...
    def __init__(self,parent):
        ...
        self.battery = parent['battery'].pop('required',None)
...
class Price(Base):
    ...
    def __init__(self,parent):
        ...
        self.b2b = parent['price'].pop('b2b', None)
        self.b2c = parent['price'].pop('b2c', None)
        self.vatnl = parent['price'].pop('vatnl', None)
        self.vatde = parent['price'].pop('vatde', None)
        self.vatfr = parent['price'].pop('vatfr', None)
        self.vatuk = parent['price'].pop('vatuk', None)
        self.discount = parent['price'].pop('discount', None)
        brand_id = parent['brand'].pop('id', None)
    ...
    b2b = Column(Float)
    b2c = Column(Float)
    vatnl = Column(Integer)
    vatde = Column(Integer)
    vatfr= Column(Integer)
    vatuk= Column(Integer)
